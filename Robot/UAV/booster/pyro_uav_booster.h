...
private:
    ...
    struct shoot_data_t
    {
        ...
        //     {0},
        //     // 等级1: Q_max 100, 80开始减速，50降到w_min
        //     {100, 80.0f, 20, 4.0, 7.2},
        //     // 等级2: Q_max 110, 80开始
        //     {110, 80.0f, 30, 4.1, 7.5},
        //     // 等级3: Q_max 120, 80开始
        //     {120, 80.0f , 40, 4.6, 8.2},
        //     // 等级4: Q_max 130, 90开始
        //     {130, 90.0f, 50, 5.0, 8.6},
        //     // 等级5: Q_max 140
        //     {140, 100.0f, 60, 5.1, 9.0},
        //     // 等级6: Q_max 150, 100开始
        //     {150, 100.0f, 70,5.8, 9.5},
        //     // 等级7: Q_max 160, 110开始
        //     {160, 110.0f, 80, 6.0, 9.8},
        //     // 等级8: Q_max 170, 110开始
        //     {170, 110.0f, 90, 6.2, 10.0},
        //     // 等级9: Q_max 180, 120开始
        //     {180, 120.0f, 100, 6.5, 10.0},
        //     // 等级10: Q_max 200, 120开始
        //     {200, 120.0f, 120, 6.8, 11.1}
        // };
        //用来弹速闭环
